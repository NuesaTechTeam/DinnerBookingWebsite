    ...
    <header className='bg-black/95 backdrop-blur-md border-b border-red-900/30 sticky top-0 z-50'>
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
        <div className='flex justify-between items-center py-3'>
          ...
          <button className='bg-gradient-to-r from-red-600 to-red-800 text-white px-6 py-2 rounded border border-red-400/50 hover:shadow-lg hover:shadow-red-500/25 transform hover:scale-105 transition-all duration-300 font-semibold tracking-wide max-sm:hidden'>
            SECURE YOUR SEAT
          </button>
        </div>
      </div>
