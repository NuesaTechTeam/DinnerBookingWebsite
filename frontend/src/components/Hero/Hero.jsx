    ...
    >
      ...
      >
        ...
        <div className='flex flex-col sm:flex-row gap-6 justify-center items-center mb-16'>
          <button className='group bg-gradient-to-r from-red-600 to-red-800 text-white px-8 md:px-10 py-3 md:py-4 border border-red-400/50 text-lg font-semibold hover:shadow-2xl hover:shadow-red-500/25 transform hover:scale-105 transition-all duration-300 flex items-center space-x-3 tracking-wider'>
            <span>JOIN THE FAMIGLIA</span>
            <ArrowRight className='w-5 h-5 group-hover:translate-x-1 transition-transform' />
          </button>
          <button className='max-md:hidden border-2 border-white text-white px-10 py-4 text-lg font-bold hover:bg-white hover:text-black transition-all duration-300 tracking-wide'>
            WATCH THE LEGACY
          </button>
        </div>
